...
% Hints: get(hObject,'String') returns contents of stature_edit as text
%        str2double(get(hObject,'String')) returns contents of stature_edit as a double
...
var = get(handles.stature_edit, 'string');
var = str2double(var);
surf(membrane(var))


% --- Executes on button press in gender_male.
function gender_male_Callback(hObject, eventdata, handles)
% hObject    handle to gender_male (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of gender_male


% --- Executes on button press in gender_female.
function gender_female_Callback(hObject, eventdata, handles)
% hObject    handle to gender_female (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of gender_female
